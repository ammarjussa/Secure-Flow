  ...
  return (
    <div className="flex">
      <div className="flex flex-1 flex-col items-center justify-between">
        <div className=" h-[calc(100vh-190px)] w-64  py-8 px-4">
        ...
        <div className="relative text-center">
          <button className="bg-blue-500 mt-4 hover:bg-blue-700 text-white font-bold py-2 px-10 rounded-3xl focus:outline-none focus:shadow-outline mb-5">
            Change details
          </button>
        </div>
      </div>
